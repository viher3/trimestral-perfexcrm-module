            ...
            <div class="col-md-12">
                <div class="panel_s">
                    <div class="panel-body">
                        <div>
                            <h4 style="margin:0"><?= _l('trimestral_title') ?></h4>
                        </div>
                        <div class="clearfix"></div>
                        <hr class="hr-panel-heading" />

                        <p><?= _l('trimestral_description') ?></p>
                        <br />

                        <?php echo form_open_multipart(admin_url('trimestral/download')) ?>
                            <div class="input-group">
                                <label for="init_date"><?= _l('trimestral_init_date') ?></label>
                                <input name="init_date" id="init_date" type="date" class="form-control input-sm" required />
                            </div>
                            <br />
                            <div class="input-group">
                                <label for="end_date"><?= _l('trimestral_end_date') ?></label>
                            ...
                            <p align="center">
                                <button type="submit" class="btn btn-info pull-left display-block mright5">
                                    <i class="fa fa-download"></i>&nbsp;&nbsp;<?= _l('trimestral_download') ?>
                                </button>
                            </p>
                        <?php echo form_close(); ?>
